...
def move_bat():
    ...
    distance_to_goal = math.sqrt(math.pow(float(des_pos_x_) - float(Cur_Pos_[0]), 2)\
                               + math.pow(float(des_pos_y_) - float(Cur_Pos_[1]), 2))
...
def main():
    ...
    des_pos_y_ = rospy.get_param('des_pos_y')
